...
<b>⊙ <i>Codec: HEVC | AAC</i></b>
<b>⊙ <i>Resolution: 1080p | 480p</i></b>
<b>╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅</b>
<blockquote>╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅
...
class TextEditor:
    ...
    async def get_upname(self, qual=""):
        ...
        if anime_name and self.pdata.get("episode_number"):
            ...
            return f"""[{Var.SECOND_BRAND}] [S{anime_season}-{'E'+str(self.pdata.get('episode_number')) if self.pdata.get('episode_number') else ''}] {titles.get('english') or titles.get('romaji') or titles.get('native')} {'['+qual+'p]' if qual else ''} {'['+codec.upper()+'] ' if codec else ''}{'['+lang+']'}.mkv"""
